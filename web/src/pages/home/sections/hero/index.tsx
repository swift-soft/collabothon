        ...
        <Slider>
          <Slide index={0}>
            ...
            >
              ...
              <Flex justify="center" mt="auto" border="none">
                <Dot slide={0} color="black">
                  <Button bg="red.700" w="40px" h="10px" mr="2px" />
                </Dot>
                <Dot slide={1} color="black">
                  <Button
                    ...
                    w="40px"
                    h="10px"
                    className="carousel__dot--selected"
                    ml="2px"
                  />
                </Dot>
              </Flex>
          ...
          <Slide index={1}>
            ...
            >
              ...
              <Flex justify="center" mt="auto" border="none">
                <Dot slide={0} color="black">
                  <Button bg="red.200" w="40px" h="10px" mr="2px" />
                </Dot>
                <Dot slide={1} color="black">
                  <Button
                    bg="red.700"
